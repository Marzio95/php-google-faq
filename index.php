...
<body>
    <header>
        <div class="top">
            <div class="p_t"><span>Google</span> Privacy e termini</div>
            <div class="utente">U</div>
        </div>
        <div class="bottom">
            <ul>
    ...
    <main>
        ...
        $array_q_a = [
            [
                ...
                'risposta' => "<p>La recente <a href='#'>decisione della Corte di giustizia dell'Unione europea</a> haprofonde conseguenze per i motori di ricerca in Europa. La Corte ha stabilito che alcuni utenti hanno ildiritto di chiedere ai motori di ricerca come Google di rimuovere risultati relativi a chiavi di ricerca cheincludono il proprio nome. Per poter essere rimossi, i risultati visualizzati devono essere inadeguati,irrilevanti o non più rilevanti, o eccessivi.</p>
        ...
        <p>Scopri quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.</p>"
            ...
            <p>Se il paese associato al tuo account non corrisponde al tuo paese di residenza, il motivo potrebbe essere la differenza tra il paese in cui lavori e il paese in cui risiedi, l'installazione di una rete privata virtuale (VPN) per mascherare il tuo indirizzo IP oppure la residenza vicino a un confine territoriale. <a href='#'>Contattaci se ritieni</a> che il paese associato al tuo account sia sbagliato.</p>"
            ],
            [
        ...
        foreach ($array_q_a as $element) {
            echo $element['domanda'];
